...
pool.model <- plm(total_fatality_rate ~ year + bac08 + bac10 + 
                    ...
                    grad_drivers_lic_law + log(percent_pop_aged_14_to_24) + 
...
* Zero conditional (strict exogeneity): The most important of these is that $\delta{u_i}$ is uncorrelated with $\delta{x_i}$. This assumption holds if the idiosyncratic error at each time t, uit, is uncorrelated with the explanatory 
