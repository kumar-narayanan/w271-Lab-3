...
controlled for. The fixed effect model could be estimated using three estimation 
methods:
...
2- i.i.d. : The observations are independent across individuals but not 
necessarily across time. This is guaranteed by random sampling of individuals.

3- Indentifiability: The regressors, including a constant, are not perfectly 
collinear, and all regressors (but the constant) have non-zero variance and not 
too many extreme values.

4- Zero conditional (strict exogeneity) - The most important of these is that 
